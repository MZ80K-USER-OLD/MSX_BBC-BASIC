...
;
	...
	EXTERN	INITIAL_SCREEN_MODE
	EXTERN	INITIAL_SCREEN_WIDTH
	EXTERN	INITTXT
	EXTERN	OSCHGMOD
	EXTERN	CHGWIDTH
	EXTERN	CheckMSXDOS
...
;
	...
	LD (INITIAL_SCREEN_MODE),A
	LD A,(WIDTH)
	LD (INITIAL_SCREEN_WIDTH),A
;
...
CLOOP:
	LD	SP,(HIMEM)
	LD	A,(CURRENT_SCREEN_MODE)
	CP	2
	JR	C,CLOOP_SCREEN_OK
	LD	HL,INITIAL_SCREEN_MODE
	CP	(HL)
	JR	NZ,CLOOP_SCREEN_RESTORE
	LD	A,(WIDTH)
	LD	HL,INITIAL_SCREEN_WIDTH
	CP	(HL)
	JR	Z,CLOOP_SCREEN_OK
CLOOP_SCREEN_RESTORE:
	LD	A,(INITIAL_SCREEN_MODE)
	LD	(CURRENT_SCREEN_MODE),A
	CALL	OSCHGMOD
	LD	A,(INITIAL_SCREEN_WIDTH)
	CALL	CHGWIDTH
CLOOP_SCREEN_OK:
...
ERRWDS:	DEFB	17H
	...
	DEFB	TLOCAL
	DEFB	0
	DEFM	"Bad sprite number"	;55
	DEFB	0
	DEFM	"Bad pattern number"	;56
	DEFB	0
;
...
LIST8:	LD	A,(HL)
	...
	CP	TSPRITE_SUB
	JR	NZ,LIST8A
	INC	HL		;skip SPRITE extension sub-token
	LD	A,T2BYTE_PREFIX
LIST8_EXT:
LIST8A:	LD	D,A
	CP	TEXIT
...
LEXAN1:	LD	(DE),A		;TRANSFER TO BUFFER
	...
	JR	NZ,LEXAN1A
	LD	A,TSPRITE_SUB
	LD	(DE),A		;SPRITE extension sub-token
	INC	DE
LEXAN1A:	INC	IY
LEXAN2:
	LD	A,E		;MAIN ENTRY
...
;
STARTMSG:
VERMSG:	DEFM	"BBC BASIC (Z80) Version 5.01  "
	DEFB	CR
	DEFB	LF
